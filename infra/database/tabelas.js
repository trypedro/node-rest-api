class Tabelas{
    ...
    criarPets(){
        const query = `CREATE TABLE IF NOT EXISTS Pets (id int NOT NULL AUTO_INCREMENT, nome varchar(50), imagem varchar(200), 
        PRIMARY KEY (id))`
        ...
        this.conexao.query(query, (erro) => {
            ...
            if(erro){
                ...
                console.log('Tabela de Pets foi executada com sucesso.')
            }
        })
    }
}
